    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">صفحة الأدمن</h1>
...
?>
               <div class="row">
                <div class="col-4 mb-3">اسم الأدمن</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user" id="AdminName" name="AdminName" aria-describedby="emailHelp" required="true" value="<?php  echo $row['AdminName'];?>"></div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">الاسم</div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">تاريخ تسجيل الأدمن(yyyy-mm-dd)</div>
