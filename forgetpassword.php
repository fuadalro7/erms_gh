...
if(isset($_POST['submit']))
  {
    ...
    $national_id=$_POST['national_id'];
        ...
        $query=mysqli_query($con,"select ID from req_info where  national_id='$national_id' and phone='$phone' ");
  ...
  <div class="container">
    ...
    echo $msg;
                  ...
                  <form class="user" method="post" action="">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="phone" name="phone" placeholder="Enter your employee Code" required="true">
                    </div>
